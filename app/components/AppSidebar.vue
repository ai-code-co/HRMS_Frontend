...
<template>
  <aside
    ...
    :class="[isHovered ? 'w-56' : 'w-16']" @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave">
    <div class="flex items-center gap-4 py-5 px-2 shrink-0 overflow-hidden">
      ...
      <span class="text-xl font-bold tracking-tight whitespace-nowrap transition-all duration-300"
    ...
    <nav class="flex-1 px-3 py-3 overflow-y-auto overflow-x-hidden scrollbar-thin">
      <UNavigationMenu orientation="vertical" :items="links" :collapsed="!isHovered" :ui="{
