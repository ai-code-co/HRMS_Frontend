...
<template>
  ...
  <aside
    class="fixed lg:relative z-[100] flex flex-col 
           h-dvh lg:h-full 
           bg-white dark:bg-gray-900
           border-r border-gray-200 dark:border-gray-800
           transition-all duration-300 ease-in-out overflow-hidden shadow-xl lg:shadow-none"
    :class="[
  ...
  >
    <!-- Logo / Menu Header -->
    <div 
      class="flex items-center gap-3 py-5 transition-all duration-300 shrink-0"
      :class="[
    ...
    >
      ...
      <!-- Title -->
      <span
        class="text-xl font-bold tracking-tight whitespace-nowrap transition-opacity duration-200"
        :class="{
   ...
   <!-- Navigation -->
    <nav 
      class="flex-1 px-2 lg:px-4 py-3 overflow-y-auto overflow-x-hidden scrollbar-thin" 
