  ...
  <div class="bg-white border border-slate-100 rounded-3xl flex flex-col shadow-sm overflow-hidden shrink-0">
    <div class="p-4 border-b border-slate-50 flex items-center gap-2">
       <div class="relative flex-1">
          ...
          <input type="text" placeholder="Search..." class="w-full bg-slate-50 border-none rounded-xl pl-9 pr-4 py-2.5 text-xs font-bold focus:ring-1 focus:ring-indigo-100 focus:outline-none" />
       </div>
