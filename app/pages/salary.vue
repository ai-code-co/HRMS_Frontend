<template>
    <div class="flex flex-col h-full bg-[#F8FAFC]">
        ...
        <div class="flex-1 flex flex-col lg:flex-row p-4 md:p-8 gap-8 overflow-hidden">
            ...
            <main
                class="flex-1 bg-white border border-slate-100 rounded-2xl shadow-sm overflow-hidden flex flex-col">
                        ...
                        <div :key="store.selectedRecordId" class="space-y-12">
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="hidden sm:flex flex-col items-end">
                                        ...
                                        <p class="text-2xl font-black text-indigo-600">${{
                                            store.selectedRecord.netPaid.toLocaleString() }}</p>
                                    </div>
                            ...
                            <div class="grid grid-cols-1 xl:grid-cols-2 gap-12">
                                <section class="space-y-6">
                                    ...
                                    <div class="space-y-1">
                                        <SalaryBreakdownRow label="Basic Salary" :value="8500" />
                                        <SalaryBreakdownRow label="HRA" :value="3200" />
                                        <SalaryBreakdownRow label="Special Allowance" :value="1500" />
                                    </div>
                                </section>
                                ...
                                <section class="space-y-6">
                                    ...
                                    <div class="space-y-1">
                                        <SalaryBreakdownRow label="Tax (TDS)" :value="1000" is-negative />
                                        <SalaryBreakdownRow label="Provident Fund" :value="450" is-negative />
                                        <SalaryBreakdownRow label="Health Insurance" :value="100" is-negative />
                                    </div>
                                </section>
                            </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <UIcon name="i-heroicons-building-library" class="w-4 h-4" /> GT-BANK SECURE
                                </div>
                            </div>
                        </div>
                    </Transition>
